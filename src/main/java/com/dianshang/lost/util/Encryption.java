...
public class Encryption {
	...
	public static void main(String args[]) {
		...
		member.setName("李秀峰");
		member.setImgPath("/upload/55555.jph");
		member.setPassword("dfghjdrftghj工业园");
		String b=member.getEmail()+";"+member.getName()+";"+member.getImgPath()+";"+member.getPassword()+";"+new Date();
...
//		System.out.println("解密为MD5后的：" + JM(KL(MD5(s))));
		String a=KL(b);
//		System.out.println(getURLEncoderString(a));
